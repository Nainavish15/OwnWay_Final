	...
	<body>
	    <nav>  
			<ul> 
				...
				<li><a href="../dashboard.php"><img src="img/logout.png"></a></li>
			</ul> 
		</nav>
		...
		<script>
			function initMap() {
			  var mapOptions = {
			    zoom: 18,
			    center: {<?php echo'lat:'. $latitudes[$lastcount-1] .', lng:'. $longitudes[$lastcount-1] ;?>}, //{lat: --- , lng: ....}
			  ...
			  startPoint = {<?php echo'lat:'. $latitudes[$lastcount-1] .', lng:'. $longitudes[$lastcount-1] ;?>};
